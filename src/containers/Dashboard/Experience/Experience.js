		...
		return (
			...
			<div>
				...
				<section className="experienceSectionContainer">
					...
					<h6>April - September, 2018</h6></div>
					...
					<p>For more detail on my work history, you can see my <a className='linkcolor' href='http://linkedin.com/deannavickers'>LinkedIn Profile</a>.</p>
</section>
</div>
		);
	}
